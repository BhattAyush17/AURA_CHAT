  ...
  public classify(text: string): SpeechStyle {
    ...
    if (hindiRatio > 90) {
      return {
        primary: "Hindi",
        secondary: "English",
        ratio: `${Math.round(hindiRatio)}/${Math.round(englishRatio)}`,
        script,
        style: "Pure Hindi",
        uiLabel: "🇮🇳 Pure Hindi",
      };
      ...
      return {
        primary: "English",
        secondary: "Hindi",
        ratio: `${Math.round(englishRatio)}/${Math.round(hindiRatio)}`,
        script: "Roman",
        style: "Pure English",
        uiLabel: "🇬🇧 Pure English",
      };
      ...
      return {
        ...
        ratio: `${Math.round(englishRatio)}/${Math.round(hindiRatio)}`,
        script: "Roman",
        style: "Mostly English",
        uiLabel: "Hindi (English Terms)",
      };
    } else {
      return {
        primary: "Mixed",
